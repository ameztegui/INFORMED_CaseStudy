...
The annual evolution of basal area, stem density and DBH for each of the studied plots between 2001 and 2100 can be found in these files: 

* <a href="file:C:/Dades/Activity/INFORMED/reports/BA_per_plot/index.html" target="_blank">Basal Area per plot</a>
* <a href="file:C:/Dades/Activity/INFORMED/reports/N_per_plot/index.html" target="_blank">Stem density per plot</a>
* <a href="file:C:/Dades/Activity/INFORMED/reports/DBH_per_plot/index.html" target="_blank">DBH per plot</a>

and their equivalents by plot and species here

* <a href="file:C:/Dades/Activity/INFORMED/reports/BA_per_plotspecies/index.html" target="_blank">Basal Area per plot and species</a>
* <a href="file:C:/Dades/Activity/INFORMED/reports/N_per_plotspecies/index.html" target="_blank">Stem density per plot and species</a>
* <a href="file:C:/Dades/Activity/INFORMED/reports/DBH_per_plotspecies/index.html" target="_blank">DBH per plot and species</a>
...
load(here("data/ES_data/mushroom_plot.Rdata"))
...
er_species %>% 
  ...
  scale_fill_manual(values = management_colors) +
  theme_bw() +
  labs(x = "Year", y = "Erosion prevention service (ratio)") +
  facet_grid( RCP ~ Forest_Type)
```
